	...
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl modal__agenda">
		<div class="modal-content">
			<div class="modal-header">
				...
				<p class="spacer">|</p>
				<p class="lead muted-text modal__added-by ">Added by Clique Studios</p>
			</div>
			<div class="modal-body">
				<div class="modal__body--title">
					<h3>Topic Title</h3>
					<p class="agenda-status text-danger"><i class="bi bi-exclamation-circle-fill"></i> High Priority
				...
				<div class="modal__body--description">
					<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis
					   ...
					   erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.</p>
					<p>Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sit amet orci.
					   Aenean
					   dignissim pellentesque
					   felis.</p>
					<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Accusantium tenetur ratione
					   excepturi
					   voluptate recusandae!
					   Temporibus optio eum in dolorum laboriosam nemo. Ipsa nesciunt quibusdam beatae iste rem
					   perspiciatis, voluptatum alias!</p>
					<p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laborum eligendi tempora explicabo,
					   soluta impedit minima, magni, perferendis velit dolore quibusdam veritatis. Blanditiis
					   beatae
					   velit aliquid reprehenderit inventore esse quibusdam ut.</p>
				</div>
					...
					<ul class="list-group list-group-flush">
						...
						<li class="list-group-item">
							<button type="button" class=" btn btn-secondary d-flex align-items-center"><i
									class="bi bi-plus me-1"></i> Add Item</button>
						</li>
					</ul>
				</div>
			</div>
		</div>
		<div class="modal-content modal__comments bg-muted">
			<div class="modal-header">
				...
				<div class="comment-list">
					<div class="comment-date-group">
						...
						<div class="comment-group-item">
							<div class="comment-item comment-item--current-user-authored">
							...
							<div class="comment-item comment-item--other-user-authored">
								<div class="comment-item__container">
									<div class="comment-item__comment">
										<p>Morbi in sem quis dui placerat ornare. Pellentesque odio nisi, euismod in,
										   pharetra
										   a,
			...
			<div class="modal-footer comment-add">
				<form class="w-100">
					<div class="row align-items-center">
						<div class="col-9">
                            <textarea class="form-control" id="comment-entry" placeholder="Add a comment..."
                                      rows="2"></textarea>
						</div>
